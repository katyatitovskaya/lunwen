    ...
    public partial class Initialll : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => x.SubscribtionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subscriptions_AspNetUsers_TargetUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_ObjectType_ObjectId",
                table: "Likes",
                columns: new[] { "UserId", "ObjectType", "ObjectId" },
                unique: true);
